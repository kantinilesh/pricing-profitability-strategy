-- Business Question 11: Which products constitute the Bottom 20% of SKUs by total gross profit contribution?
-- Purpose: Identifies low-performing or margin-diluting SKUs for price adjustment or portfolio rationalization.
...
WHERE profit_quintile = 5  -- Bottom 20% Quintile
ORDER BY total_gross_profit_inr ASC;
